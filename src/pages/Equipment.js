...
function Equipment() {
  ...
  return (
    <div className="h-[calc(260vh-120px)] sm:h-[calc(260vh-120px)] w-screen bg-white flex justify-center items-center">
      <div className="h-[calc(260vh-120px)] sm:h-[calc(260vh-120px)] lg:w-[1000px] sm:w-[700px] w-[400px]  flex flex-col">
