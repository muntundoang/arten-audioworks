...
function Value() {
  ...
  return (
    <div className="sm:h-[calc(100vh-64px)] h-[calc(200vh-64px)] w-screen bg-primary flex justify-center items-center">
      <div className="sm:h-[calc(100vh-64px)] h-[calc(200vh-64px)] lg:w-[1000px] sm:w-[700px] w-[400px] flex flex-col items-center">
